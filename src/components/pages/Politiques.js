...
const Politiques = () => {
  return (
    <>
     <Helmet>
            <title>Politiques confidentialité - Bookish</title>
            <meta name="description" content="Bienvenue sur les politiques de confidentialité de Bookish." />
            <meta property="og:url" content="https://bookish-landing.vercel.app/politiques"/>
          </Helmet>
        ...
        <div className="space-y-8 text-left">
          ...
          <div>
            ...
            <p className="text-justify">
              Le site web Bookish est détenu par l’équipe 8, qui est un contrôleur de données de vos données personnelles.
              Nous avons adopté cette politique de confidentialité, qui détermine la manière dont nous traitons les informations collectées par Bookish, qui fournit également les raisons pour lesquelles nous devons collecter certaines données personnelles vous concernant. Par conséquent, vous devez lire cette politique de confidentialité avant d’utiliser le site web de Bookish.
              Nous prenons soin de vos données personnelles et nous nous engageons à en garantir la confidentialité et la sécurité.
            </p>
          </div>
          <div>
            <h2 className="text-2xl font-semibold mb-2">Les informations personnelles que nous collectons</h2>
            <p className="text-justify">
              Lorsque vous visitez le site de Bookish, nous recueillons automatiquement certaines informations sur votre appareil, notamment des informations sur votre navigateur web, votre adresse IP, votre fuseau horaire et certains des cookies installés sur votre appareil. En outre, lorsque vous naviguez sur le site, nous recueillons des informations sur les pages web ou les produits individuels que vous consultez, sur les sites web ou les termes de recherche qui vous ont renvoyé au site et sur la manière dont vous interagissez avec le site. Nous désignons ces informations collectées automatiquement par le terme « informations sur les appareils ». En outre, nous pourrions collecter les données personnelles que vous nous fournissez (y compris, mais sans s’y limiter, le nom, le prénom, l’adresse, les informations de paiement, etc.) lors de l’inscription afin de pouvoir exécuter le contrat.
            </p>
          </div>
          <div>
            <h2 className="text-2xl font-semibold mb-2">Pourquoi traitons-nous vos données ?</h2>
            <p className="text-justify">
          ...
          <div>
            <h2 className="text-2xl font-semibold mb-2">Sécurité de l’information :</h2>
            <p className="text-justify">
          ...
          <div>
            <h2 className="text-2xl font-semibold mb-2">Divulgation légale :</h2>
            <p className="text-justify">
