  ...
  return (
    <nav className="w-full bg-green px-4 py-3 flex justify-between items-center fixed top-0 left-0 z-50 shadow-lg">
      ...
      <div className="sm:hidden">
        <button onClick={toggleMobileMenu} className="text-yellow focus:outline-none">
      ...
      >
        <button onClick={toggleMobileMenu} className="absolute top-4 right-4 text-yellow focus:outline-none">
          <FaTimes size={24} />
        </button>
        <a
          href="/about"
