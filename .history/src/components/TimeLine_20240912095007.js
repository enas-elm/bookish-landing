...
const menuItems = [
  ...
  },
  {
    id: 4,
    label: "ORGANISEZ",
    description: "Organisez vos lectures en créant des listes personnalisées qui vous ressemblent. 
Rejoignez des clubs de lecture pour échanger et découvrir de nouveaux horizons littéraires avec d'autres passionnés."",
    color: "#55917E",
