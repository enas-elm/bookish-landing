  ...
  return (
    <div className="p-40 overflow-hidden lg:flex lg:flex-row lg:justify-around lg:items-center">
      ...
      <div className="w-96 h-96 flex flex-col items-start p-4">
        ...
        <button className="bg-yellow text-green px-6 py-2 mt-10 rounded-full hover:bg-yellow-500 hover:scale-105 hover:shadow-lg transition transform duration-300 ease-in-out">
          Devenir testeur
        </button>
      </div>
