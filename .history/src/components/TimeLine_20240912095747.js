...
const menuItems = [
  {
    ...
    label: "DECOUVERT",
    description:
      "Rejoignez une communauté de passionnés qui partagent votre amour pour les livres. Restez connecter avec vos amis et découvrez leurs nouvelles aventures , tout en partageant les vôtres !",
    color: "#FEDF6F",
  ...
  },
  {
    ...
    label: "DISCUTEZ",
    description:
      "Rejoignez des clubs ou partagez des messages avec d'autres fans de livres clubs ou partagez des messages avec d'autres passionnés",
    color: "#8EBDAF",
  ...
  },
  {
    id: 4,
    label: "ORGANISEZ",
    description: "Organisez vos lectures en créant des listes personnalisées qui vous ressemblent. Rejoignez des clubs de lecture pour échanger et découvrir de nouveaux horizons littéraires avec d'autres passionnés.",
    color: "#55917E",
