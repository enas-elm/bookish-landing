...
import "../TimelineMenu.css"; // Créez ce fichier pour ajouter les styles
...
function TimelineMenu() {
  ...
  return (
    <div className="p-40 lg:flex lg:flex-row lg:justify-around lg:items-center">
      ...
      <div
        className={`w-471 h-611 flex flex-col justify-center items-center p-4 rounded-[43px] content-container ${direction}`}
        style={{
